    ...
    try:
        ...
        for listing in listings[:3]:
            if listing:
                ...
                results.append(
                    {"platform": "Amazon", "title": title, "price": price, "rating": rating, "review": review, "url": url})
        return results
    ...
    try:
        ...
        for listing in listings[:3]:
            if listing:
                ...
                results.append(
                    {"platform": "Snapdeal", "title": title, "price": price, "rating": rating, "review": review, "url": url})
        return results
    except Exception as e:
        print("Error scraping Snapdeal:", e)
        return []
...
def scrape_flipkart(search_query):
    try:
        ...
        for e in elements[:3]:
            ...
            reviews = e.find("span", class_="_2_R_DZ")
            if reviews:
                reviews = reviews.get_text(strip=True)

            rating = e.find("div", class_="_2kHMtA").find('a').find("div", class_="col col-7-12").find(
                "div", class_="_3LWZlK")
            ...
            result.append({"platform": "Flipkart", "title": title, "price": price, "rating": rating, "review": reviews,
                           "url": url})
